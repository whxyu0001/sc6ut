...
module.exports = async (client, player, track, payload) => {
  ...
  const thing = new MessageEmbed()
    .setDescription(`${i18n.__("cmd.play.embed")}\n [${track.title}](https://discord.gg/sc6ut) - \`[${convertTime(track.duration)}]\``)
    .setFooter("Thanks For Using Me <3")
    .setImage(`https://img.youtube.com/vi/${track.identifier}/mqdefault.jpg`)
    .setColor(client.embedColor)
    .setTimestamp()
  const But1 = new MessageButton().setEmoji("<:volume_down:1106940806155219065>").setCustomId("vdown").setStyle("SECONDARY");
    
   const But2 = new MessageButton().setEmoji("<:stop:1106940808172666960>").setCustomId("stop").setStyle("SECONDARY");

   const But3 = new MessageButton().setCustomId("pause").setEmoji("<:pause:1106940810995449866>").setStyle("SECONDARY");

   const But4 = new MessageButton().setCustomId("skip").setEmoji("<:Skip:1106940812798992464>").setStyle("SECONDARY");
    
   const But5 = new MessageButton().setCustomId("vup").setEmoji("<:volume_up:1106940816104108145>").setStyle("SECONDARY");
